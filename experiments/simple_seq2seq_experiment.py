...
from models.lstm_simple_seq2seq import LstmSimpleSeq2Seq
...
experiment_builder = ExperimentBuilder(
	args = args,
	# if you change something here, remember to change it in evaluator
	model = LstmSimpleSeq2Seq(batch_size=args.batch_size, segment_size=args.segment_size, 
