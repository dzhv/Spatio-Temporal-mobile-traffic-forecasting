...
class CnnConvLSTMAttention(KerasModel):
	def __init__(self, gpus=1, batch_size=50, segment_size=12, window_size=11,
		cnn_filters=[25,50,50], encoder_filters=[50], decoder_filters=[50],
		...
		out = TimeDistributed(Conv2D(cnn_filters[0], kernel_size=3, activation='tanh', padding='same'))(encoder_inputs)
